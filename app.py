...
<div class="stats">
<div class="stat"><h3>150+</h3><p>Созданных сайтов</p></div>
<div class="stat"><h3>98%</h3><p>Довольных клиентов</p></div>
<div class="stat"><h3>24/7</h3><p>Поддержка</p></div>
<div class="stat"><h3>4★</h3><p>Средняя оценка</p></div>
</div>
...
<div class="cards">
<div class="card"><h3>Строительная компания</h3><p>Корпоративный сайт под ключ.</p></div>
<div class="card"><h3>Магазин одежды</h3><p>Интернет-магазин с каталогом товаров.</p></div>
<div class="card"><h3>Юридические услуги</h3><p>Лендинг для привлечения клиентов.</p></div>
<div class="card"><h3>Кафе и рестораны</h3><p>Сайт с онлайн бронированием.</p></div>
<div class="card"><h3>Автосервис</h3><p>Продвижение услуг ремонта авто.</p></div>
<div class="card"><h3>IT компания</h3><p>Премиальный корпоративный сайт.</p></div>
</div>
...
<div class="cards">
<div class="testimonial">⭐⭐⭐⭐⭐<br><br>Сайт сделали быстро и качественно.</div>
<div class="testimonial">⭐⭐⭐⭐⭐<br><br>Очень понравился дизайн и поддержка.</div>
<div class="testimonial">⭐⭐⭐⭐⭐<br><br>После запуска сайта стало больше клиентов.</div>
</div>
...
<textarea rows="6" name="message" placeholder="Опишите проект"></textarea>
...
Сообщение: {message}"""
    ...
    url = "https://wa.me/992109919197?text=" + urllib.parse.quote(text)
